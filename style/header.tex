...
\institute[]{
    ...
    \and
    \href{https://twitter.com/MelBioInf}{\inlinepng{img/2021 Twitter logo - blue.png} @MelBioInf}
    }
...
%%%%%%%%%%%%%%%%%%%%%%%%
% LATEX-ONLY CENTERING %
%%%%%%%%%%%%%%%%%%%%%%%%


% override problems with pandoc centering when converting from markdown
\def\begincentre{\begin{centering}}
\def\endcentre{\end{centering}}
